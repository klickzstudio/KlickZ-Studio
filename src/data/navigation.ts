...
export const navLinks: NavLink[] = [
  { label: 'Home', href: '/' },
  {
    ...
    children: [
      ...
      {
        label: 'Videos',
        href: '/candid-wedding-films',
        children: [
          { label: 'Candid Wedding Films', href: '/candid-wedding-films' },
          { label: 'Outdoor', href: '/outdoor-films' },
        ],
      },
    ],
  },
  {
    ...
    children: [
      ...
      { label: 'Baby Portrait', href: '/baby-shower-photography-chennai' },
      { label: 'Videography', href: '/candid-wedding-films' },
      { label: 'Outdoor', href: '/outdoor-wedding-photography' },
    ],
  },
