    ...
    children: [
      {
        ...
        children: [
          ...
          { label: 'Brahmin', href: ROUTES.SERVICES.BRAHMIN_WEDDING },
          { label: 'Telugu', href: ROUTES.SERVICES.TELUGU_WEDDING },
          { label: 'Hindu', href: ROUTES.SERVICES.HINDU_WEDDING },
          { label: 'Engagement', href: ROUTES.SERVICES.ENGAGEMENT },
          { label: 'Malayali', href: ROUTES.SERVICES.MALAYALI_WEDDING },
          { label: 'Punjabi', href: ROUTES.SERVICES.PUNJABI_WEDDING },
          { label: 'Sangeet', href: ROUTES.SERVICES.SANGEET },
          { label: 'Haldi', href: ROUTES.SERVICES.HALDI },
        ],
      },
