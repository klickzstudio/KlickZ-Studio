    ...
    <section className="py-20 md:py-28 bg-white text-[#1A1A1A]" id="testimonials">
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        <ScrollReveal className="text-center pt-2">
          ...
          <a
            href="https://g.page/r/klickzstudio"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-2 bg-[#EAB308] hover:bg-[#D97706] text-[#1A1A1A] hover:text-white font-lato text-xs font-semibold px-6 py-3 rounded-lg shadow-xs transition-all duration-300"
          >
